...
class PIT38Fields:
    ...
    def print(self) -> None:
        ...
        if self.year == 2024:
            print(f"  Poz. 22 (Inne przychody): {self.poz22:.2f} PLN")
            print(f"  Poz. 23 (Koszty uzyskania przychodow): {self.poz23:.2f} PLN")
            print(f"  Poz. 26 (Dochod): {capital_income:.2f} PLN")
            print(f"  Poz. 27 (Strata): {capital_loss:.2f} PLN")
            print("  Poz. 28 (Straty z lat ubieglych): 0.00 PLN")
            ...
            print("  Poz. 30 (Straty z lat ubieglych): 0.00 PLN")
            ...
            print(f"  Poz. 34 (Podatek zaplacony za granica): {self.poz32:.2f} PLN")
        ...
        if self.year == 2024:
            ...
            print(f"  Poz. 46 (Podatek niepobrany przez platnika): {self.section_g_uncollected_tax:.2f} PLN")
            print(f"  Poz. 47 (Podatek 19% od przychodow czesci G): {self.poz45:.2f} PLN")
            print(f"  Poz. 48 (Podatek zaplacony za granica): {self.poz46:.2f} PLN")
